...
export const metadata: Metadata = {
  ...
  // PWA-related app icons. The web app manifest itself is emitted by
  // app/manifest.ts (Next.js auto-injects <link rel="manifest"> when
  // a manifest file exists); these declarations cover the favicon and
  // Apple touch icon, which the manifest does not own.
  icons: {
    icon: [
